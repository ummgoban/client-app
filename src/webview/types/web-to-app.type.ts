export type WebToAppMethodType =
  | 'NATIVE_NAVIGATION'
  | 'NATIVE_GO_BACK'
  | 'AUTHORIZATION'
  | 'PLAIN'
...
export interface WebToAppPayloadType {
...
export interface WebToAppAuthorizedPayload extends WebToAppPayloadType {
  type: 'AUTHORIZATION';
}
